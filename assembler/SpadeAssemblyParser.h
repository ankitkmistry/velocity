...
class  SpadeAssemblyParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    ...
    RuleMethod = 4, RuleArgs = 5, RuleArg = 6, RuleLocs = 7, RuleLocal = 8, 
    RuleCode = 9, RuleLine = 10, RuleExceptionTable = 11, RuleExceptionItem = 12, 
    RuleClass = 13, RuleAccessor = 14, RuleFields = 15, RuleField = 16, 
    RuleValue = 17, RuleArray = 18, RuleFloat = 19
  };

  explicit SpadeAssemblyParser(antlr4::TokenStream *input);

  SpadeAssemblyParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~SpadeAssemblyParser() override;
  ...
  public:
    ...
    LocsContext *locs();
    CodeContext *code();
    ExceptionTableContext *exceptionTable();
  ...
  class  LocsContext : public antlr4::ParserRuleContext {
  public:
    LocsContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *NUMBER();
  ...
  class  ExceptionTableContext : public antlr4::ParserRuleContext {
  public:
    ExceptionTableContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
